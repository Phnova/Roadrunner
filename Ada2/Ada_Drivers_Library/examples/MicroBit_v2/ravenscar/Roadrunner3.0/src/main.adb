...
--          Change optional directions to rotation, not lateral direction. Ensure safe rotational direction with side sensors -- Kinda DONE
--          Finalize driveability of car
--          Look at timing and scheduling
--
--
--
--
